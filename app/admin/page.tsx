    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <p className="text-white/30 text-xs tracking-[0.4em] uppercase text-center mb-3">
            Espace
          </p>
          <h1 className="text-3xl font-bold tracking-tight text-white text-center mb-8">
            Administrateur
          </h1>
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="border-b border-white/10 px-6 py-5 flex justify-between items-center max-w-7xl mx-auto">
        ...
        <button
          ...
          className="text-white/30 text-xs tracking-widest uppercase hover:text-white transition-colors"
        >
          Déconnexion
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {message && (
          <div className="mb-4 text-sm text-white/70 border border-white/10 rounded-xl px-4 py-3">
            {message}
          </div>
        )}
        ...
        {onglet === "produits" && (
          <div className="pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {produits.map((p) => (
                <div key={p.id} className="border border-white/10 rounded-2xl p-4 space-y-2">
                  ...
                  <div className="flex gap-2 text-xs">
                    {p.nouveaute && (
                      <span className="bg-white/10 text-white/60 px-2 py-0.5 rounded-full">Nouveauté</span>
                    )}
                    {p.soldOut && (
                      <span className="bg-red-500/20 text-red-400 px-2 py-0.5 rounded-full">Sold Out</span>
                    )}
                  </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center px-4">
          <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto space-y-4">
            ...
            {[
              ...
              { label: "Image (ex: /produits/article_10.jpeg)", key: "image", type: "text" },
